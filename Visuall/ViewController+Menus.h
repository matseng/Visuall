...
@interface ViewController (Menus) <UIScrollViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, TopMenuProtocol>  // added UINavigationControllerDelegate to suppress a warning
